...
--
-- Host: localhost:3306
-- Generation Time: Jun 04, 2026 at 03:03 AM
...
(1, 'Cuci Kering', 'Pakaian di cuci dan dikeringkan', 300, 0),
...
(5, 'Reguler', 'layanan reguler', 7000, 0);
...
INSERT INTO `pelanggan` (`id_pelanggan`, `nama_pelanggan`, `alamat`, `no_hp`, `catatan`) VALUES
(1, 'Nadifa', 'Bandung', '08123456789', NULL),
(2, 'Anggi', 'Indramayu', '082345678901', NULL),
(3, 'Aryadi', 'Indramayu', '083456789012', NULL),
(4, 'aryadi', 'jalan-jalan', '08', NULL),
(5, 'riyad', 'jlan baru', '0819087654', NULL),
(6, 'arr', 'jalan-jalan-jalan', '097', NULL),
(7, 'arr', 'jalan-jalan-jalan', '097', NULL),
(8, 'b', 'nomor', '088', NULL),
(9, 'seseorang', 'Rumah-rumahan', '08765432190', NULL),
(10, 'siapa ya', 'kecamatan', '0987654321', NULL),
(11, 'coba lagi', 'coba-coba', '088888888', NULL),
(12, 'Aryadi', 'hvghgchg', '0819087654', NULL),
(13, 'anggiks', 'Polindra', '0812345678', NULL),
(14, 'Dexter', 'Jln. Netherlands lama No. 7, Kec. Amsterdam,  Kab. Belanda, Eropa 321654', '0231987456', NULL),
(15, 'Dexter', 'Jln. Netherlands lama No. 7, Kec. Amsterdam,  Kab. Belanda, Eropa 321654', '0231987456', NULL),
(16, 'Dexter', 'jln. amsterdam, kec. belanda, kab. eropa', '0231987456', NULL),
(17, 'nama pelanggan', 'Jalan lohbener', '0800000000', 'catatan catatan catatan catatan catatan catatan catatan catatan catatan catatan catatan catatan catatan catatan catatan catatan catatan catatan catatan catatan catatan catatan catatan catatan catatan catatan catatan catatan catatan catatan catatan catatan catatan catatan catatan');
...
INSERT INTO `pesanan` (`id_pesanan`, `tanggal_masuk`, `tanggal_selesai`, `status_pesanan`, `id_pelanggan`, `id_pegawai`, `updated_at`, `total_harga`, `status_pembayaran`) VALUES
(1, '2026-04-09', '2026-05-22', 'selesai', 1, 1, '2026-05-22 14:11:04', 0, 'lunas'),
(3, '2026-04-12', '2026-05-22', 'selesai', 4, 1, '2026-05-22 14:11:26', 0, 'lunas'),
(4, '2026-04-22', NULL, 'diproses', 6, NULL, '2026-05-21 02:10:08', 0, 'belum_bayar'),
(5, '2026-04-22', NULL, 'diproses', 7, NULL, '2026-05-21 02:10:08', 0, 'belum_bayar'),
(6, '2026-04-22', NULL, 'diproses', 8, NULL, '2026-05-21 02:10:08', 0, 'belum_bayar'),
(7, '2026-04-23', NULL, 'diproses', 9, NULL, '2026-05-21 02:10:08', 0, 'belum_bayar'),
(8, '2026-04-23', NULL, 'diproses', 10, NULL, '2026-05-23 01:03:49', 0, 'lunas'),
(9, '2026-04-29', '2026-05-23', 'selesai', 11, NULL, '2026-05-22 19:53:34', 0, 'lunas'),
(10, '2026-05-07', '2026-05-22', 'selesai', 12, NULL, '2026-05-22 14:28:48', 0, 'lunas'),
(11, '2026-05-07', '2026-05-22', 'selesai', 13, NULL, '2026-05-22 14:10:26', 0, 'lunas'),
(13, '2026-05-22', '2026-05-31', 'diambil', 16, NULL, '2026-05-31 07:54:52', 0, 'lunas'),
(14, '2026-05-31', NULL, 'diproses', 17, NULL, '2026-06-01 18:22:51', 0, 'dp');
...
(1, 1, '2026-05-21 17:00:00', 'cash', 10000),
(3, 3, '2026-05-21 17:00:00', 'cash', 28000),
(4, 11, '2026-05-21 17:00:00', 'cash', 10000),
(5, 9, '2026-05-22 17:00:00', 'cash', 20000),
(6, 8, '2026-05-22 17:00:00', 'cash', 10000),
(7, 10, '2026-05-30 17:00:00', 'cash', 21000),
(8, 13, '2026-05-30 17:00:00', 'cash', 40000),
(9, 14, '2026-06-02 17:00:00', 'cash', 10000);
