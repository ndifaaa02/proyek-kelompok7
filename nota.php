...
<div class="container py-5">
    <div class="card border-0 shadow-sm rounded-4 p-5 mx-auto" style="max-width: 800px; background-color: #f8f9fa;">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <span class="badge bg-light text-warning border border-warning rounded-pill px-3 py-2">DP (Belum
                Lunas)</span>
            <?php else: ?>
            <span class="badge bg-light text-danger border border-danger rounded-pill px-3 py-2">Belum Bayar</span>
            <?php endif; ?>
        </div>
            ...
            <table class="table table-borderless mb-0">
                ...
                <tfoot class="bg-light border-top">
                    <tr>
                        ...
                        <td class="py-3 text-end px-4 fw-bold text-primary h4 mb-0">Rp
                            <?= number_format($total_akhir); ?></td>
                    </tr>
                </tfoot>
            </table>
        </div>
